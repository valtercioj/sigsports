...
export function declaracao(
          ...
          [
            {
              text: [
                {
                  text: "Declaramos para os fins que se fizerem necessários, e por nos haver sido solicitado, que ",
                  bold: false,
                },
                ...
                {
                  text: ", é aluno regularmente matriculado na turma de ",
                  bold: false,
                },
                { text: nomeTurma, bold: true },
                { text: ", no turno ", bold: false },
                { text: turno, bold: true },
                { text: ", desta Instituição de Ensino", bold: false },
              ],
              fillColor: "#F7F9FB",
              margin: [0, 14],
              fontSize: 12,
              lineHeight: 2.5, // Ajuste o valor para o espaçamento desejado
          ...
          [
            {
              text: [
                {
                  text: "Situação atual de matrícula: \n",
                  bold: false,
                  alignment: "center",
                },
                {
              ...
              borderColor: ["#058C42", "#058C42", "#058C42", "#058C42"],
              margin: [0, 20, 0, 17],
              lineHeight: 2,
              fontSize: 18,
            },
  ...
  pdfMake.createPdf(docDefinitions).download("declaracao.pdf");
}
